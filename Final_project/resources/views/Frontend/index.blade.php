...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap CSS -->
        <link href="{{ asset('2127_little_fashion/css/bootstrap.min.css') }}" rel="stylesheet">
        <link href="{{ asset('2127_little_fashion/css/bootstrap-icons.css') }}" rel="stylesheet">
        <link rel="stylesheet" href="{{ asset('2127_little_fashion/css/slick.css') }}"/>
        <link href="{{ asset('2127_little_fashion/css/tooplate-little-fashion.css') }}" rel="stylesheet">
<!--
...
-->
    ...
    <body>
        ...
        <main>
            ...
            <section class="slick-slideshow">   
                <div class="slick-custom">
                    <img src="{{ asset("2127_little_fashion/images/slideshow/medium-shot-business-women-high-five.jpeg")}}" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="{{("2127_little_fashion/images/slideshow/team-meeting-renewable-energy-project.jpeg")}}" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="{{ asset("2127_little_fashion/images/slideshow/two-business-partners-working-together-office-computer.jpeg")}}" class="img-fluid" alt="">
        ...
        <!-- JAVASCRIPT FILES -->
        <script src="{{ asset('2127_little_fashion/js/jquery.min.js') }}"></script>
    <script src="{{ asset('2127_little_fashion/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('2127_little_fashion/js/Headroom.js') }}"></script>
    <script src="{{ asset('2127_little_fashion/js/jQuery.headroom.js') }}"></script>
    <script src="{{ asset('2127_little_fashion/js/slick.min.js') }}"></script>
    <script src="{{ asset('2127_little_fashion/js/custom.js') }}"></script>
